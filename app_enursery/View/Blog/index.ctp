	...
	?>
		...
		<div>
			<div class="floatLeft" style="width:250px;">
				<div class=" "><?php echo $this->Html->link($blogTitle, '/blog/show/'.$blogID.'/'.$blogTitleSlug, array('title'=>$blogTitle));?></div>	
				<div style="font-style:normal; font-size:90%; ">
					<p><time><?php echo $blogTime;?></time></p> 
					Views: <?php echo $blogViews;?>
				</div>
			</div>
			<div class="floatLeft" style="margin-left:20px; width:620px; text-align:justify;">				
				<?php echo $blogDesc;?><br>			
				<span class="more floatRight" ><?php echo $this->Html->link('Read more...', '/blog/show/'.$blogID.'/'.$blogTitleSlug, array('title'=>$blogTitle));?></span>
			</div>
