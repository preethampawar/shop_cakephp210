                    ...
                    <div class="ft_gallery clear">
                        <ul>
                            ...
                            foreach ($images as $image) {
                                ...
                                $productImageUrl = $this->Html->url($this->Img->showImage('img/images/' . $imageID, array('height' => '60', 'width' => '60', 'type' => 'crop', 'quality' => '75', 'filename' => $imageCaptionSlug), array('style' => '', 'height' => '60', 'width' => '60', 'alt' => $imageCaption, 'title' => $imageCaption, 'escape' => false), true), true);
