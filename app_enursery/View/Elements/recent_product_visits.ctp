	...
	<div>	
		...
		?>
			<div style="float:left; margin:0 5px 5px 0px; padding:4px; border:1px solid #ddd;">
				<?php
				$image = $this->Img->showImage('img/images/'.$imageID, array('height'=>'60','width'=>'60','type'=>'crop', 'quality'=>'50', 'filename'=>$productNameSlug), array('style'=>'', 'alt'=>$productName, 'title'=>$imageCaption, 'escape'=>false));
