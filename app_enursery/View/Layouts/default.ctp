...
<head>
	...
	} elseif ($this->Session->read('Site.service_type') == 'Health Service') {
...
<div class="wrapper row5">
	...
	<footer id="copyright" class="clear">
		<p class="fl_right"><br>Powered
			by <?php echo $this->Html->link(Configure::read('BaseDomain'), Configure::read('BaseDomainUrl'), array('title' => Configure::read('BaseDomain'), 'style' => 'padding:2px; border:1px solid #888;', 'target' => '_blank', 'rel' => "noopener")); ?>
		</p>
	</footer>
</div>
<!-- / Copyright -->
