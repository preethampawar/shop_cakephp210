...
<div id="adminAddContent">	
	<section>
		...
		<div class="floatRight"><?php echo $this->Html->Link('+ Add New Category', '/admin/categories/add', array('title'=>'Add new category'));?></div>
		<div class='clear'></div>
		<br>
		<?php		
		...
		if(!empty($categories)) {		
			...
			echo $this->Form->input('Product.name', array('label'=>false, 'title'=>'Add new product', 'style'=>'width:300px; margin-right:20px;'));
			...
			echo $this->Form->input('Category.id', array('label'=>false, 'type'=>'select', 'multiple'=>'checkbox', 'options'=>$categoryOptions, 'title'=>'Select Category', 'style'=>'', 'div'=>false));
			echo '<br>';
