			...
			foreach($allCategories as $row) {	
				...
				?>
						...
						foreach($row['CategoryProducts'] as $row2) {
							...
							?>
							<div style="float:left; border:1px solid #eee; margin:0 7px 20px 0; padding:0px;  width:200px; height:<?php echo $height;?>;">
								<div style="padding:5px 0px;">
									<div style="text-align:center;">
										...
										<p>
										<?php 
											$productImage = $this->Img->showImage('img/images/'.$imageID, array('height'=>'150','width'=>'150','type'=>'crop', 'quality'=>'85', 'filename'=>$productNameSlug), array('style'=>'', 'height'=>'150','width'=>'150', 'alt'=>$productName, 'id'=>'image'.$categoryID.'-'.$imageID));
									...
									if($this->Session->read('Site.request_price_quote')) { ?>
										<div style="text-align:center;">
											<?php echo $this->Form->submit('Request Price Quote', array('div'=>false, 'escape'=>false, 'style'=>'width:180px; margin-bottom:8px;', 'onclick'=>"showRequestPriceQuoteForm('$categoryID','$productID', '$productTitle')"));?>
											
											<?php echo $this->Form->submit('+ Add To My Shopping List', array('div'=>false, 'escape'=>false, 'style'=>'width:180px;', 'onclick'=>"showAddToCartForm('$categoryID','$productID', '$productTitle')"));?>
										</div>	
									<?php 
									} 
									?>	
							...
							if($productCount == 3) {
								if($adCount<3) {
									$adCount++;							
									?>
									<div style="float:left; border:1px solid #eee; margin:0 7px 20px 0; padding:0px;  width:200px; height:<?php echo $height;?>; overflow:hidden;">
