...
<div id="adminAddContent">
	<section>
		...
		if (!empty($categories)) {
			...
			<br>
			<?php
			echo $this->Form->input('Product.active', array('label' => 'Is Active', 'title' => 'Status Active', 'style' => 'width:10px; margin-right:5px;', 'after' => '<br>', 'type' => 'checkbox'));
			echo $this->Form->input('Product.featured', array('label' => 'Featured Product', 'title' => 'Featured Product', 'style' => 'width:10px; margin-right:5px;', 'after' => '<br>', 'type' => 'checkbox'));
			echo $this->Form->input('Product.request_price_quote', array('label' => 'Show Request Price Quote', 'title' => 'Show Request Price Quote', 'style' => 'width:10px; margin-right:5px;', 'after' => '<br>', 'type' => 'checkbox'));
