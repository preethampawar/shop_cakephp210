...
<section>
	...
	<article>
		...
		<?php
			...
			echo '<br>';
			echo $this->Form->input('Content.top_nav_menu', array('type'=>'checkbox', 'label'=>'Show in top navigation menu'));
			echo '<br>';
			echo $this->Form->input('Content.footer_menu', array('type'=>'checkbox', 'label'=>'Show in footer'));
			echo '<br>';
			echo $this->Form->input('Content.title', array('label'=>'Page Title'));
			echo '<br>';
