<?php
echo $this->Html->meta('keywords', 'Request price quote, Get price quotation, plants quotation', array('inline'=>false));
echo $this->Html->meta('description', 'Get price quotation for plants.', array('inline'=>false));
?>
...
?>
	...
	<div>
		<?php echo $this->Form->create(null, array('encoding'=>false));?>			
		<table style='max-width:500px; font-size:13px;'>		
			<tr>
				<td width='110'>Name *</td>
				<td><?php echo $this->Form->input('ShoppingCart.name', array('label'=>false, 'type'=>'text', 'div'=>false, 'required'=>true, 'placeholder'=>'Enter Full Name..', 'style'=>'width:100%', 'title'=>'Enter Full Name'));?></td>
			</tr>
			<tr>
				<td>Phone *</td>
				<td><?php echo $this->Form->input('ShoppingCart.phone', array('label'=>false, 'type'=>'text', 'div'=>false, 'required'=>true, 'placeholder'=>'Enter Phone Number..', 'style'=>'width:100%', 'title'=>'Enter Phone Number'));?></td>
			</tr>
			<tr>
				<td>Email Address *</td>
				<td><?php echo $this->Form->input('ShoppingCart.email', array('label'=>false, 'type'=>'email', 'div'=>false, 'required'=>true, 'placeholder'=>'Enter Email Address..', 'style'=>'width:100%', 'title'=>'Enter Email Address'));?></td>
			</tr>
			
			<tr>
				<td valign='top'>Address *</td>
				<td><?php echo $this->Form->input('ShoppingCart.address', array('label'=>false, 'div'=>false, 'type'=>'textarea', 'rows'=>'1', 'required'=>true, 'placeholder'=>'Your message  goes here..', 'title'=>'Enter your delivery address', 'style'=>'width:100%'));?></td>
			</tr>	
			<tr>
				<td valign='top'>Message</td>
				<td><?php echo $this->Form->input('ShoppingCart.message', array('label'=>false, 'div'=>false, 'type'=>'textarea', 'rows'=>'1', 'required'=>false, 'placeholder'=>'Your message  goes here..', 'title'=>'Your message  goes here..', 'style'=>'width:100%'));?></td>
			</tr>		
			<tr>
				<td>&nbsp;</td>
				<td>
					<br>
					<?php 
					echo $this->Form->submit('Submit &raquo;', array('escape'=>false, 'div'=>false, 'class'=>'button small green', 'title'=>'Submit'));
					echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		...
		<table class='table' style="width:auto; font-size:13px;">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $this->Html->link($categoryName, '/products/show/'.$categoryID.'/'.$categoryNameSlug, array('style'=>' padding:0px;', 'title'=>$categoryNameSlug, 'escape'=>false));?></td>
