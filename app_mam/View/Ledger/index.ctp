<h1>Ledger Account  - Year <?php echo date('Y');?></h1>
<div class="clear"></div>
<br><br>
<h2>Sales Account</h2>
<?php
...
?>
	<table style="width:950px;">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $i;?></td>
				<td><?php echo date('d M Y', strtotime($row['Ledger']['date']));?></td>
...
<h3>Profit (or) Loss - Year <?php echo date('Y');?></h3>
...
<br>
<br>
<h3>Pending Payments - Year <?php echo date('Y');?></h3>
