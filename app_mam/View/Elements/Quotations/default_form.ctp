		...
		<div style="margin:0px; padding:0px;">	
			<table style="width:100%" class="noBorderTable">				
				<tbody>
					...
					<tr>	
						<td style="text-align:right; font-weight:bold;">Sales Tax: </td>
						<td style="font-weight:bold;">
							<?php echo $this->Form->input('Quotation.sales_tax', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()'));?> %
						</td>
					</tr>					
					<tr>	
