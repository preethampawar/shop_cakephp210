			...
			<table style="width:100%" class="noBorderTable">				
				<tr>
					<td style="width:400px;">
						...
						echo $this->Form->input('from_name', array('label'=>'Name', 'type'=>'text', 'placeholder'=>'From Name', 'required'=>true, 'default'=>$default, 'label'=>'Name'));
							
						echo $this->Form->input('from_address', array('label'=>'Address', 'type'=>'textarea', 'rows'=>'2', 'cols'=>'10', 'default'=>$this->Session->read('Company.address'), 'required'=>true, 'placeholder'=>'From Address'));
						?>
					</td>
					<td>&nbsp;</td>
		...
		<div style="margin:0px; padding:0px;">	
			<table style="width:100%" class="noBorderTable">				
				...
				<tr>
					<td style="width:400px;">
						<?php
						echo $this->Form->input('to_name', array('label'=>'Name', 'type'=>'text', 'placeholder'=>'To Name', 'required'=>true));
						echo $this->Form->input('to_address', array('label'=>'Address', 'type'=>'textarea', 'rows'=>'2', 'cols'=>'10', 'placeholder'=>'To Address', 'required'=>true));
						?>
					</td>
					<td>&nbsp;</td>
					<td style="width:300px;">
						<?php
						$img = $this->Html->image('calendar.gif', array('onclick'=>"$('#datepicker').focus()"));
						echo $this->Form->input('validity', array('label'=>'Validity (Y-m-d)*', 'id'=>'datepicker2', 'type'=>'text', 'required'=>true, 'after'=>'&nbsp;'.$img.'<input type="text" id="alternate2" style="border:0px solid #fff; color:#ff0000; background:transparent;">', 'readonly'=>true, 'placeholder'=>'Click to open calendar', 'style'=>'width:85%'));	
						?>
					</td>
				</tr>
			</table>
		...
		<div style="margin:0px; padding:0px;">
			<table style="width:100%" class="noBorderTable">				
				<tr>
					<td>							
						<?php
						echo $this->Form->input('comments', array('label'=>'<b>Comments or Special instructions:</b>', 'type'=>'textarea', 'rows'=>'1', 'cols'=>'10', 'placeholder'=>'Comments'));
						?>						
					</td>
				</tr>
			</table>
		...
		<div style="margin:0px; padding:0px;">
			<table style="width:100%" class="noBorderTable" cellpadding='1' cellspacing='1'>				
				<tbody id='itemsTbody'>
					...
					<tr>							
						<td><?php echo $this->Form->input('EntityItem.item.0', array('type'=>'text', 'label'=>false, 'div'=>false, 'lineno'=>0, 'required'=>true));?></td>
						<td><?php echo $this->Form->input('EntityItem.description.0', array('label'=>false, 'type'=>'textarea', 'rows'=>1, 'style'=>'height:17px;', 'div'=>false, 'lineno'=>0, 'required'=>true));?></td>
						<td><?php echo $this->Form->input('EntityItem.size.0', array('type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'', 'lineno'=>0));?></td>
						<td><?php echo $this->Form->input('EntityItem.age.0', array('type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'', 'lineno'=>0));?></td>
						<td><?php echo $this->Form->input('EntityItem.quantity.0', array('type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'0', 'lineno'=>0, 'onchange'=>'calculateQuotationTotal()', 'required'=>true));?></td>
						<td><?php echo $this->Form->input('EntityItem.unitrate.0', array('type'=>'text', 'label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'lineno'=>0, 'onchange'=>'calculateQuotationTotal()', 'required'=>true));?></td>
						<td><?php echo $this->Form->input('EntityItem.amount.0', array('type'=>'text', 'readonly'=>true, 'label'=>false, 'class'=>'readonly lineamount', 'div'=>false, 'style'=>'width:100px;', 'placeholder'=>'0.00', 'lineno'=>0));?></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
				...
				<tbody>
					<tr>	
						...
						<td style="width:130px; font-weight:bold;">
							<?php 
								echo $this->Form->input('Quotation.subtotal', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'readonly'=>true, 'class'=>'readonly', 'style'=>'width:100px;'));
					...
					<tr>	
						...
						<td style="font-weight:bold;">
							<?php echo $this->Form->input('Quotation.discount', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()'));?> %
						</td>
					</tr>
					<tr>	
						<td style="text-align:right; font-weight:bold;">Tax Rate: </td>
						<td style="font-weight:bold;">
							<?php echo $this->Form->input('Quotation.tax_rate', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'style'=>'width:100px;', 'onchange'=>'calculateQuotationTotal()'));?> %
						</td>
					</tr>								
					<tr>	
						...
						<td style="font-weight:bold;">
							<?php 
								echo $this->Form->input('Quotation.total_amount', array('label'=>false, 'div'=>false, 'placeholder'=>'0.00', 'readonly'=>true, 'class'=>'readonly', 'style'=>'width:100px;'));
								echo ' '.$this->Session->read('Company.currency');
							?>
						</td>
					</tr>
