			...
			<div style="padding:2mm;">
				<table style="width:100%;" class='borderTable'>
					<tr>
						...
						<th style="width:25mm;">UnitRate(<?php echo $this->Session->read('Company.currency');?>)</th>
						<th style="width:25mm;">Amount (<?php echo $this->Session->read('Company.currency');?>)</th>
					</tr>
					<?php 
					$i=0;
				...
				<table style="width:100%;" class="smallPadding">				
					...
					<tr>
						...
						<td style="text-align:right;">								
							<?php echo  ($quotationInfo['Quotation']['sales_tax']) ? $quotationInfo['Quotation']['sales_tax'] : '0';?> % 	
						</td>
					</tr>
					<tr>
