		...
		<div>
			<div class="floatLeft" style="width:250px; float:left; margin-right:20px;text-align:center;">
				<div class="corner categorySelectionDiv" style="height:320px;">
					...
					<?php
					echo $this->Form->input('Category.parent_id', array('label'=>false, 'options'=>$categories, 'escape'=>false, 'empty'=>'-- None --', 'default'=>$default, 'size'=>'17', 'style'=>'border:0px; padding:0px; background:transparent; font-size:95%;'));?>
				</div>
			</div>
