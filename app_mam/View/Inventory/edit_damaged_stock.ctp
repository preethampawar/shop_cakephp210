	...
	<div>	
		<div class="floatLeft" style="width:300px; float:left; margin-right:20px;text-align:center;">
			<div class="corner categorySelectionDiv" style="height:350px;">
				...
				?>				
				<?php echo $this->Form->input('category_id', array('label'=>false, 'options'=>$categories, 'escape'=>false, 'empty'=>false, 'size'=>'17', 'style'=>'border:0px; padding:0px; background:transparent;', 'required'=>true, 'id'=>'category', 'onchange'=>'showCategoryPrice(this.id);'));?>
