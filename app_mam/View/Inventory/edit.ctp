		...
		<div class="floatLeft" style="width:300px; float:left; margin-right:20px;text-align:center;">
			<div class="corner categorySelectionDiv" style="height:350px;">
				<div style="padding:5px; margin:0px; border-bottom:2px solid #aaa;"><b>Category: <?php echo $inventory['Category']['name'];?></b></div>		
					<?php echo $this->Form->input('Inventory.category_id', array('label'=>false, 'options'=>$categories, 'escape'=>false, 'empty'=>false, 'default'=>$inventory['Inventory']['category_id'], 'size'=>'17', 'style'=>'border:0px; padding:0px; font-size:95%; background:transparent;', 'required'=>true));?>
