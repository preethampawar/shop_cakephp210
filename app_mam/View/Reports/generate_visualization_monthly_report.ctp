...
<div id="search" class="corner setBackground" style=" padding:10px 10px 0px 10px; margin-bottom:10px;">
<?php echo $this->Form->create();?>	
	
	<div class="floatLeft" style="width:150px; padding:0px; margin-right:10px;">
		<?php
		$options = Configure::read('BusinessTypes');	
		echo $this->Form->input('business_type', array('label'=>'Select Account Book', 'div'=>false, 'options'=>$options, 'escape'=>false, 'empty'=>' - All -', 'required'=>false));
		?>
	</div>
	...
	<div class="floatLeft" style="width:200px; padding:0px; margin-right:10px;">		
		<?php
		echo $this->Form->input('Report.group_id', array('label'=>'Select Group', 'div'=>true, 'options'=>$groups, 'escape'=>false, 'empty'=>' - All - ', 'required'=>false));
		?>
	</div>	
...
<?php
echo $this->element('Reports/monthly_visualization_report');
?>
