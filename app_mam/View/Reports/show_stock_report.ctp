...
foreach($temp as $category_id=>$row2) {
	...
	<table style="width:900px;" cellpadding='0' cellspacing='0'>
		<tr>
			...
			<th width='10'>&nbsp;</th>
			<th width='70'>Bal. Stock</th>
			<th style="border-right:1px solid #fff;">&nbsp;</th>
			<th width='10'>&nbsp;</th>
			<th width='70'>Prev. Bal.</th>
			<th style="border-right:1px solid #fff;">&nbsp;</th>
			<th width='10'>&nbsp;</th>			
			<th width='70'>Total Bal.</th>
			<th width='10'>&nbsp;</th>
		</tr>
	<?php
	$i=0;
	...
	?>
		<tr>
			...
			<td style="font-weight:bold;"><?php echo ($bal_stock) ? (($bal_stock > 0) ? '<span class="debit">'.abs($bal_stock).'</span>' : '<span class="credit">'.abs($bal_stock).'</span>') : '-';?></td>
