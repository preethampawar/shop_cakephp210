...
<head>
	...
	<?php
		...
		echo $this->Html->script('jquery.corner');	// DC Mega Menu JS
...
<body>
	<div id="container">
		<div id="header" <?php echo (!$this->Session->check('UserCompany.company_id')) ? 'style="border-bottom:1px solid #cacaca;"' : '';?>>
			...
			<div class="floatRight"><?php echo $this->Html->link('&nbsp;&raquo; Logout', '/users/logout', array('style'=>'text-decoration:none;', 'escape'=>false));?></div>	
		...
		<div id="nav">
			...
			if($showTopNavMenu) {
				echo $this->element('admin_top_nav_menu');
			}
			?>
		</div>
		<div id="content">
