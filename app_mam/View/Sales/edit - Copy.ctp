...
?>
<div>
	<h2 class="floatLeft">Modify Sales Record</h2>
	...
	<div style="width:400px;">
		...
		echo $this->Form->input('payment_amount', array('label'=>'Received Amount('.$this->Session->read('Company.currency').')', 'required'=>false, 'default'=>'0', 'id'=>'PaymentAmount')); 
		...
		<?php echo '&nbsp;'.$this->Html->link('Delete &nbsp;&nbsp;&nbsp; x', '/sales/delete/'.$dataID, array('class'=>'button small red floatRight', 'escape'=>false), 'Are you sure you want to delete this record?');?>		
	</div>
		
		<?php 
		echo $this->Form->end();
		// echo '<br>&nbsp;&laquo;&nbsp;'.$this->Html->link('Cancel', '/sales/');	
		?>
</div>
