...
<?php echo $this->Html->link($productCategoryInfo['ProductCategory']['name'], ['controller' => 'product_categories', 'action' => 'index', $productCategoryInfo['ProductCategory']['id']], ['title' => 'Show all products in ' . $productCategoryInfo['ProductCategory']['name'] . ' category']); ?> &raquo; <?php echo $productCategoryInfo['Product']['name']; ?>
<br>
