...
<div class="row">
	...
	<div class="col-xs-7 col-sm-7 col-lg-9">
		...
		<?php if ($products) { ?>
			...
			<p>
				<?php echo $categoryID ? '<br>' . $this->Html->link('+ Add Product', ['controller' => 'products', 'action' => 'add', $category['ProductCategory']['id']], ['title' => $category['ProductCategory']['name'] . ' - Add Product', 'escape' => false, 'class' => 'btn btn-primary btn-xs']) : ''; ?>
			</p>
