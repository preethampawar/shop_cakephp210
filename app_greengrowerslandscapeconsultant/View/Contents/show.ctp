	...
	<article>
		...
		<div id="contentImages">	
			...
			foreach($images as $row) { 
				...
				$imageUrl = $this->Html->url($this->Img->showImage('img/images/'.$imageID, array('height'=>'600','width'=>'600','type'=>'auto', 'quality'=>'75', 'filename'=>$imageCaptionSlug), array('style'=>'', 'alt'=>$contentInfo['Content']['title'], 'title'=>$imageCaption), true), true);
				$imageThumbUrl = $this->Html->url($this->Img->showImage('img/images/'.$imageID, array('height'=>'150','width'=>'150','type'=>'crop', 'quality'=>'75', 'filename'=>$imageCaptionSlug), array('style'=>'', 'alt'=>$contentInfo['Content']['title'], 'title'=>$imageCaption), true), true);		
...
<script>
$('#content<?php echo $contentInfo['Content']['id'];?>').attr('class', 'active');
</script>
