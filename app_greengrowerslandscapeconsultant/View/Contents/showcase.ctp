	...
	<div class="slider-wrapper theme-default">				
		<div id="slider" class="nivoSlider">							
			...
			foreach($contentInfo['Images'] as $image) {				
				...
				$imageUrl = $this->Img->showImage('img/images/'.$imageID, array('height'=>'500','width'=>'960','type'=>'crop', 'quality'=>'95', 'filename'=>$imageID), array('style'=>'', 'alt'=>$imageCaption, 'title'=>$imageCaption, 'escape'=>false), true);
