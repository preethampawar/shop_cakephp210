	...
	<div>
		...
		?>
			<div style="float:left; margin:0 5px 8px 0;">
				<?php
				$image = $this->Img->showImage('img/images/'.$imageID, array('height'=>'60','width'=>'60','type'=>'crop', 'quality'=>'50', 'filename'=>$productNameSlug), array('style'=>'', 'height'=>'60' ,'width'=>'60', 'alt'=>$productName, 'title'=>$imageCaption, 'escape'=>false));
