...
<div id='adminCategoryNavigation'>
	<ul>
		...
		?>
			<li>
				<div style="color:orange; float:left; margin-top:5px;">&raquo;</div><?php echo $this->Html->link($categoryDisplayName, '/admin/categories/showProducts/'.$categoryID.'/'.$categoryNameSlug, array('title'=>$categoryName, 'class'=>'floatLeft', 'style'=>'width:180px;'));?>					
