<div>
	...
	<?php echo $this->Html->link('Modify Site Information &raquo;', array('controller'=>'sites', 'action'=>'edit'), array('escape'=>false, 'class'=>'button')); ?>
	<br><br>
	<hr>
	...
	<table style="font-weight:bold; width:95%;">
		<tr>
			<td style="vertical-align:top;">				
				<?php echo $this->Form->input('Site.show_products', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteShowProducts">Show Products </label> <br>
				
				<?php echo $this->Form->input('Site.featured_products', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteFeaturedProducts">Show Featured Products</label> <br>
				
				<?php echo $this->Form->input('Site.request_price_quote', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteRequestPriceQuote">Show Request Price Quote</label> <br>
				
				<?php echo $this->Form->input('Site.image_gallery', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteImageGallery">Show Products Photo Gallery</label>
				
			</td>			
			<td style="vertical-align:top; padding-left:50px;">
				<?php echo $this->Form->input('Site.show_landing_page', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteShowLandingPage">Show Landing Page</label> <br>
				
				<?php echo $this->Form->input('Site.show_blog', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteShowBlog">Show Blog <br>
				
				<?php echo $this->Form->input('Site.under_maintenance', array('div'=>false, 'label'=>false, 'disabled'=>true));?> <label for="SiteUnderMaintenance">Under Maintenance</label> <br>
	...
	<table style="width:95%;" cellpadding='0' cellspacing='0' class='table'>		
		...
		<tr>			
			...
			<td style="width:10px;">:</td>
			<td><pre><?php echo $siteInfo['Site']['address']; ?></pre></td>
		</tr>
		<tr>			
		...
		<tr>			
			...
			<td style="width:10px;">:</td>
			<td><div style="max-width:600px;word-wrap:break-word;"><?php echo htmlentities($siteInfo['Site']['analytics_code']); ?></div></td>
		</tr>
		<tr>			
			<td style='font-weight:bold;'>Search Engine Code</td>
			<td style="width:10px;">:</td>
			<td><div style="max-width:600px;word-wrap:break-word;"><?php echo htmlentities($siteInfo['Site']['search_engine_code']); ?></div></td>
		</tr>	
		<tr>			
			<td style='font-weight:bold;'>Map Code</td>
			<td style="width:10px;">:</td>
			<td><div style="max-width:600px;word-wrap:break-word;"><?php echo htmlentities($siteInfo['Site']['embed_map']); ?></div></td>
		</tr>		
	</table>
