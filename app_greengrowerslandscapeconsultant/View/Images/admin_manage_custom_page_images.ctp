...
<div id="manageImages">
	<section>		
		...
		<br>
		<header>
			<h2>Manage Images for '<?php echo $contentInfo['Content']['title'];?>' Page</h2>
		</header>
		...
		echo $this->Form->input('Image.content_id', array('type'=>'hidden', 'value'=>$contentInfo['Content']['id']));
		echo '<br>';
	...
	<br><hr><br>
	<section>
		<header><h2><?php echo $contentInfo['Content']['title'];?> Page: Images List</h2></header>
		<div>			
			<?php 
