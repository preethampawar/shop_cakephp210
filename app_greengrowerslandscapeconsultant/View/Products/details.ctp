...
<nav>
	<ul id="productNav">
		...
		<li><?php echo $this->Html->link($productName, '/products/details/'.$categoryID.'/'.$productID.'/'.$categoryNameSlug.'/'.$productNameSlug);?></li>
	</ul>
	<div class='clear'></div>
</nav>
...
<div id="productImages">	
	...
	foreach($productImages as $row) { 
		...
		$imageUrl = $this->Html->url($this->Img->showImage('img/images/'.$imageID, array('height'=>'600','width'=>'600','type'=>'auto', 'quality'=>'75', 'filename'=>$imageCaptionSlug), array('style'=>'', 'alt'=>$productName, 'title'=>$imageCaption), true), true);
		$imageThumbUrl = $this->Html->url($this->Img->showImage('img/images/'.$imageID, array('height'=>'150','width'=>'150','type'=>'crop', 'quality'=>'75', 'filename'=>$productNameSlug), array('style'=>'', 'alt'=>$productName, 'title'=>$imageCaption), true), true);		
	...
	<div style="float:left; border:0px solid #fff; width:auto; padding:2px;">
		<a href="<?php echo $imageUrl;?>" title='<?php echo $imageCaption;?>'>
			<img src="<?php echo $imageThumbUrl;?>" alt="<?php echo $productName;?>" width='150' height='150'/>
			<?php 
...
<div>
	...
	<div style="float:left">
		<div class="fb-like" data-send="true" data-href="<?php echo $url;?>" data-width="350" data-show-faces="true"></div>
	</div>
