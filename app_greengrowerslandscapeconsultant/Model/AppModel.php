...
class AppModel extends Model {	
	 ...
	 */
	function getLandingPageInfoWithImages() {
		App::uses('Content', 'Model');
		$this->Content = new Content;
		
		$conditions = array('Content.site_id'=>$this->getSiteID(), 'Content.landing_page'=>'1');		
		...
		if(!empty($contentInfo)) {		
			...
			$imageConditions = array('Image.content_id'=>$contentInfo['Content']['id'], 'Image.highlight'=>1); 
			$images = $this->Image->find('all', array('conditions'=>$imageConditions));
