...
class UsersController extends AppController
{
	...
	public function login()
	{
		...
		if ($this->request->is('post')) {
			...
			if ($this->Auth->login()) {
				...
				$this->errorMsg(__('Invalid email or password, try again'));
			}
		}
	...
	public function add()
	{
		...
		if ($this->request->is('post')) {
			...
			if ($this->User->save($this->request->data)) {
				...
				$this->successMsg($msg, 'default', ['class' => 'success']);
				$this->redirect(['controller' => 'stores', 'action' => 'index']);
			} else {
				$this->errorMsg(__('The user could not be saved. Please, try again.'));
			}
		}
	...
	public function delete($id = null)
	{
		...
		$this->errorMsg(__('User was not deleted'));
		$this->redirect(['controller' => 'stores', 'action' => 'index']);
	}
}
