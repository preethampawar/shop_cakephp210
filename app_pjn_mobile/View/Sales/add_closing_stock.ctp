...
if ($productsInfo) {
	...
	<div id="AddSaleProductDiv" class="well">
		...
		<div id="paramsDiv">
			...
			<div style="float:left; clear:none;">
				<?php
				echo $this->Form->input('closing_stock_qty', ['type' => 'number', 'min' => '0', 'max' => '99999', 'label' => 'Closing Quantity', 'required' => true, 'oninput' => 'setTotalPrice()', 'title' => 'Values should be between 0 to 99999', 'style' => 'width:80px;']);
				?>
