...
<div class="container">
    ...
    if ($result) {
        ...
        <label for="showStoreAccessPasswords">
            <input type="checkbox" id="showStoreAccessPasswords" name="showStoreAccessPasswords" value="1" onclick="showStoreAccessPasswords(this)"> Show/Hide Access Passwords
        </label>
        <br>
