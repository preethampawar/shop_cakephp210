    ...
    <div class="col-xs-7 col-sm-7 col-lg-9">
        ...
        <h2>
            ...
            if ($categoryInfo) {
                ...
                ?>
                <span style="font-size:11px; font-style:italic;">[<?php echo $this->Html->link('Show all records', ['controller' => 'cashbook', 'action' => 'index'], ['title' => 'Show all category records']); ?>]</span>
                <?php
            } else {
                echo 'All Records';
            }
