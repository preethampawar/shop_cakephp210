...
<h1>Edit Product: <?php echo $this->Html->link($productCategoryInfo['ProductCategory']['name'], ['controller' => 'products', 'action' => 'index', $productCategoryInfo['ProductCategory']['id']], ['title' => 'Show all products in ' . $productCategoryInfo['ProductCategory']['name'] . ' category']); ?> &raquo; <?php echo $productCategoryInfo['Product']['name']; ?></h1>
