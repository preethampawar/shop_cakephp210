        ...
        <table class='table'>
            ...
            foreach ($salaries as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" style="" name="invoice_remove_product_<?php echo $row['Salary']['id']; ?>" id="invoice_remove_product_<?php echo $row['Salary']['id']; ?>" action="<?php echo $this->Html->url("/salaries/remove/" . $row['Salary']['id']); ?>">
                            <input type="submit" value="Remove" name="Remove" onclick="if (confirm('Are you sure you want to delete this record - <?php echo $row['Salary']['employee_name']; ?> from the list?')) { $('#invoice_remove_product_<?php echo $row['Salary']['id']; ?>').submit(); } event.returnValue = false; return false;">
                        </form>
