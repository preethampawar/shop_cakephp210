            ...
            <table class='table' style="width:100%;">
                ...
                foreach ($records as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" style="" name="invoice_bank_product_<?php echo $row['Bank']['id']; ?>" id="invoice_bank_product_<?php echo $row['Bank']['id']; ?>" action="<?php echo $this->Html->url("/banks/remove/" . $row['Bank']['id']); ?>">
                                <a href="#" name="Remove" onclick="if (confirm('Are you sure you want to delete this record from the list?')) { $('#invoice_bank_product_<?php echo $row['Bank']['id']; ?>').submit(); } event.returnValue = false; return false;" class="btn btn-danger btn-xs">
