...
<div id="AddSalaryDiv">
    ...
    echo $this->Form->input('save_data', ['type' => 'hidden', 'value' => 0]);
    echo $this->Form->input('selected_from_date', ['type' => 'hidden', 'value' => $fromDate]);
    echo $this->Form->input('selected_to_date', ['type' => 'hidden', 'value' => $toDate]);
    echo $this->Form->input('transaction_balance', ['type' => 'hidden', 'value' => $transaction_balance]);
    echo $this->Form->input('short_value', ['type' => 'hidden', 'value' => 0]);
    ?>
    <div id="paramsDiv">
        <div style="float:left; clear:none;">
            <?php echo $this->Form->input('from_date', ['label' => 'From Date', 'required' => true, 'type' => 'date', 'value' => $fromDate, 'onchange' => 'hideForm()']); ?>
        </div>
        <div style="float:left; clear:none;">
            <?php echo $this->Form->input('to_date', ['label' => 'To Date', 'required' => true, 'type' => 'date', 'value' => $toDate, 'onchange' => 'hideForm()']); ?>
        </div>
        <div style="float:left; clear:none; padding-top:5px;">
            <br>
            &nbsp;&nbsp;<?php echo $this->Form->submit('Get details', ['id' => 'submit', 'type' => 'submit', 'div' => false]); ?>
        </div>
        <hr style="clear:both;">
        <div class="partialForm well">
            ...
            <div style="float:left; clear:none;">
                <?php echo $this->Form->input('opening_balance', ['empty' => false, 'label' => 'Opening Balance', 'required' => true, 'type' => 'number', 'escape' => false, 'onchange' => 'updateCounterSheetInfo()', 'default' => 0]); ?>
            </div>
            <div style="float:left; clear:none;">
                <?php
                echo $this->Form->input('total_sales', ['type' => 'hidden', 'value' => $sale_amount]);
                echo $this->Form->input('tmp_sales', ['type' => 'text', 'label' => 'Total Sales', 'disabled' => true, 'title' => 'Total Sales', 'value' => $sale_amount]);
                ?>
            </div>
            <div style="float:left; clear:both;">
                <?php echo $this->Form->input('counter_cash', ['label' => 'Counter Cash', 'required' => true, 'type' => 'number', 'default' => 0, 'onchange' => 'updateCounterSheetInfo()']); ?>
            </div>
            <div style="float:left; clear:none;">
                <?php echo $this->Form->input('counter_cash_by_card', ['label' => 'Counter Cash By Card', 'required' => true, 'type' => 'number', 'default' => 0, 'onchange' => 'updateCounterSheetInfo()']); ?>
            </div>
            <div style="float:left; clear:none;">
                <?php
                echo $this->Form->input('expenses', ['type' => 'hidden', 'value' => $expense_amount]);
                echo $this->Form->input('tmp_expenses', ['label' => 'Expenses', 'disabled' => true, 'value' => $expense_amount, 'style' => 'width:100px;']);
                ?>
            </div>
            <div style="float:left; clear:none;">
                <?php echo $this->Form->input('closing_balance', ['label' => 'Closing Balance', 'required' => true, 'type' => 'number', 'default' => 0, 'style' => 'width:100px;', 'onchange' => 'updateCounterSheetInfo()']); ?>
            </div>

            <div style="clear:both; margin:0; padding:0;"></div>
            <div style="padding-bottom:5px;">
                <?php echo $this->Form->submit('Save Counter Balance Sheet', ['id' => 'SubmitForm', 'type' => 'submit', 'div' => false, 'onclick' => 'return submitCounterSheetForm()']); ?>
                <br>
            </div>
        </div>
    </div>
        ...
        <div>
            <table class="table">
                ...
                <tr class="bold" style="border-top:2px solid #666; border-bottom:2px solid #666;">
                    ...
                    <td>
                        <div class="note">(Opening Balance + Sale Value) - (Counter Cash + Card + Expenses + Closing Balance + Transaction Balance)</div>
                    </td>
                </tr>
                <?php
                if (!empty($transactions)) {
                    ...
                    <tr class="bold" style="border-top:2px solid #666; border-bottom:2px solid #666;">
                        ...
                        <td>
                            <div class="note">(Balance Amount - Transaction Balance)</div>
                        </td>
                    </tr>
                    <?php
                }
