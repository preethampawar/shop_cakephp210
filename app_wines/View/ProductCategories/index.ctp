			...
			foreach($products as $row) {
				if(!empty($row['Product'])) {		
					...
					<tr>
						...
						<td><?php echo $this->Html->link($product['name'], array('controller'=>'products', 'action'=>'edit', $row['ProductCategory']['id'], $product['id']), array('title'=>'Edit Product - '.$product['name']));?></td>
