...
if ($viewType != 'download') {
    ...
    if (isset($invoices) and !empty($invoices)) {
        ...
        <table class='table' style="width:100%;">
            ...
            foreach ($invoices as $row) {
                ...
                <tr>
                    ...
                    <td><?php echo $row['Invoice']['special_margin']; ?></td>
                    <td><?php echo $row['Invoice']['invoice_value'] + $row['Invoice']['special_margin']; ?></td>
            ...
            <tr>
                ...
                <td title="Total MRP Rounding Up"><?php echo number_format($total_special_margin, '2', '.', ''); ?></td>
                ...
                <td><?php //echo $total_dd_amount;?></td>
                <td><?php //echo $total_dd_amount;?></td>
            </tr>
            </tfoot>
        </table>
        ...
        <table class="table table-values" style="width:400px;">
            ...
            <tr>
                ...
                <td><?php echo number_format($total_special_margin, '2', '.', ''); ?></td>
            </tr>
            <tr>
    ...
    $csv .= "\r\n";
    if (!empty($invoices)) {
        $csv .= implode(['Sl.No.', 'Invoice No.', 'Invoice Date', 'Invoice Value', 'MRP Rounding Up', 'Net Invoice Value', 'TCS', 'DD Amount', 'Prev Credit', 'Credit Balance'], ",") . "\r\n";
        $k = 0;
        ...
        $csv .= " , , Total: ,$total_invoice_value, $total_special_margin, $total_net_invoice_value, $total_tcs_value, $total_dd_amount, , ";
