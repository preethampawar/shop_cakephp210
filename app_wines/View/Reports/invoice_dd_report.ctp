...
if ($viewType != 'download') {
    ...
    if (!empty($invoices)) {
        ...
        $csv .= " , , Total: ,$total_invoice_value, $total_mrp_rounding_off, $total_net_invoice_value, $total_retail_shop_excise_turnover_tax, $total_special_excise_cess, $total_tcs_value, $total_dd_amount, , ";
