...
<?php echo $this->Form->create('Report', ['target' => '_blank', 'id' => 'SaleReportForm']); ?>
<div id="paramsDiv">
    <div style="float:left; clear:none;">
        <?php echo $this->Form->input('category_id', ['empty' => 'All', 'label' => 'Category', 'type' => 'select', 'options' => $productCategoriesList, 'escape' => false, 'onchange' => '$("#SaleReportForm").removeAttr("target"); $("#SaleReportForm").removeAttr("action"); $("#SaleReportForm").submit();', 'style' => 'width:200px;']); ?>
    </div>
    <div style="float:left; clear:none; ">
    ...
    <div style="float:left; clear:none; ">
        ...
        echo $this->Form->submit('Generate Report', ['id' => 'SubmitForm', 'onclick' => '$("#SaleReportForm").attr("action","' . $url . '");']); ?>
    </div>
