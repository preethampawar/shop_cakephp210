...
if ($employeeInfo) {
    ?>
    <h1>Employee Details (<?php echo $this->Html->link('Edit', ['controller' => 'employees', 'action' => 'edit', $employeeInfo['Employee']['id']], ['title' => 'Edit Employee - ' . $employeeInfo['Employee']['name']]); ?>)</h1>
    <br>
    <p>
