<p><?php echo $this->Html->link('Show all Suppliers', ['controller' => 'suppliers', 'action' => 'index'], ['title' => 'Go back to Suppliers list']); ?></p>
<h1>
    Supplier Name: <?php echo $supplierInfo['Supplier']['name']; ?>
    <span style="font-size:11px; font-style:italic;">[<?php echo $this->Html->link('Edit', ['controller' => 'suppliers', 'action' => 'edit', $supplierInfo['Supplier']['id']], ['title' => 'Edit ' . $supplierInfo['Supplier']['name']]); ?>]</span>
</h1>
