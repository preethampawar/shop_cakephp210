        ...
        <table class='table'>
            ...
            foreach ($suppliers as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" style="" name="supplier_<?php echo $row['Supplier']['id']; ?>" id="supplier_<?php echo $row['Supplier']['id']; ?>" action="<?php echo $this->Html->url("/suppliers/remove/" . $row['Supplier']['id']); ?>">
                            ...
                            |
                            <input type="submit" value="Remove" name="Remove" onclick="if (confirm('Are you sure you want to delete this supplier - <?php echo $row['Supplier']['name']; ?>?')) { $('#supplier_<?php echo $row['Supplier']['id']; ?>').submit(); } event.returnValue = false; return false;">
