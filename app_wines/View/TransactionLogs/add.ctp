...
<div id="AddTransactionLogDiv">
    <div style="float:left; width:500px;">
        ...
        ?>
        <div id="paramsDiv">
            <?php echo $this->Form->input('payment_type', ['label' => 'Payment Type', 'required' => true, 'type' => 'select', 'options' => ['expense' => 'Payment Made', 'income' => 'Payment Received'], 'default' => 'expense']); ?>
        </div>
        <div style="float:left; clear:none;">
            <?php echo $this->Form->input('payment_date', ['label' => 'Payment Date', 'required' => true, 'type' => 'date', 'value' => $payment_date, 'default' => $payment_date]); ?>
        </div>
        <div style="float:left; clear:both;">
            <?php echo $this->Form->input('amount', ['empty' => false, 'label' => 'Payment Amount', 'required' => true, 'type' => 'number', 'escape' => false, 'default' => 0, 'style' => 'width:80px;']); ?>
        </div>
        <div style="float:left; clear:none;">
            <?php echo $this->Form->input('title', ['label' => 'Description', 'required' => true, 'type' => 'text', 'style' => 'width:200px;']); ?>
        </div>
        <div style="float:left; clear:none;">
            <?php echo $this->Form->input('tag_id', ['label' => 'Tag', 'required' => true, 'type' => 'select', 'options' => $tags, 'class' => 'autoSuggest', 'default' => $tag_id]); ?>
        </div>
        <div style="float:left; clear:both; padding-top:5px;">
            &nbsp;<?php echo $this->Form->submit('Submit', ['id' => 'submit', 'type' => 'submit', 'div' => false]); ?>
        </div>
    ...
    <div style="float:left; padding-left:10px; border-left:1px solid #666;">
        <?php
        echo $this->Form->create('Tag', ['url' => '/TransactionLogs/addTag']);
        echo $this->Form->input('name', ['label' => 'Add New Tag', 'required' => true, 'type' => 'text', 'style' => 'width:150px;']);
        echo '&nbsp;' . $this->Form->submit('Create Tag', ['id' => 'submit', 'type' => 'submit', 'div' => false]);
        echo $this->Form->end();
        ?>
    </div>
