...
<div>
	...
	<div class="mt-4">
		...
		<?php
		echo $this->Form->select('type', User::USER_TYPE_OPTIONS, ['class'=>'form-select', 'label' => false, 'default'=>$userInfo['User']['type'], 'empty'=>false]);
		?>
	</div>
	...
	<div class="mt-4">
		<button type="submit" class="btn btn-md btn-primary" id="customerRegisterButton">Update</button>
		<a href="/admin/users/manage" class="btn btn-md btn-outline-secondary ms-3" >Cancel</a>
