...
<div>
	...
	<?php echo '&nbsp;' . $this->Html->link('Change Privacy Settings', '/users/changePrivacySettings', ['escape' => false, 'class' => 'button small green floatRight']); ?>
	<div class="floatRight" style="width:15px;">&nbsp;</div>
	<?php echo '&nbsp;' . $this->Html->link('Edit Profile', '/users/editProfile', ['escape' => false, 'class' => 'button small green floatRight']); ?>
	<div class="clear"></div>
	<br/>
	...
	<table style='width:500px;'>
		...
		if ($userInfo['User']['type'] == 'student') {
			...
			<tr class='UserRow'>
				...
				<td>:</td>
				<td>
					From <?php echo ($userInfo['User']['service_start_year']) ? $userInfo['User']['service_start_year'] : '-'; ?>
					to <?php echo ($userInfo['User']['service_end_year']) ? $userInfo['User']['service_end_year'] : '-'; ?></td>
				<td>&nbsp;</td>
			</tr>
			<?php
		}
