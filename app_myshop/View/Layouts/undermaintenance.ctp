	...
	<footer id="copyright" class="clear">
		<p class="fl_left">
			<a href="http://www.w3.org/html/logo/">
				<img src="http://www.w3.org/html/logo/badge/html5-badge-h-performance-semantics.png" width="120"
					 height="40" alt="HTML5 Powered with Performance &amp; Integration, and Semantics"
					 title="HTML5 Powered with Performance &amp; Integration, and Semantics">
			</a>
		</p>
		<p class="fl_left" style="margin-left:160px"><br>Copyright &copy; 2012 - All Rights Reserved
			- <?php echo $this->Html->link($this->request->host(), $this->Html->url('/', true)); ?></p>
		<p class="fl_right"><br>Powered
			by <?php echo $this->Html->link(Configure::read('BaseDomain'), Configure::read('BaseDomainUrl'), ['title' => Configure::read('BaseDomain'), 'style' => 'padding:2px; border:1px solid #888;', 'target' => '_blank']); ?>
		</p>
	</footer>
</div>
<!-- / Copyright -->
