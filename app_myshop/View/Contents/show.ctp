...
$this->Html->meta('keywords', $contentInfo['Content']['meta_keywords'], ['inline' => false]);
$this->Html->meta('description', $contentInfo['Content']['meta_description'], ['inline' => false]);
?>
<section>
	<article>
		...
		if (!empty($images)) {
			...
			<div id="contentImages">
				...
				foreach ($images as $row) {
					...
					$imageUrl = $this->Html->url($this->Img->showImage('img/images/' . $imageID, ['height' => '600', 'width' => '600', 'type' => 'auto', 'quality' => '85', 'filename' => $imageCaptionSlug], ['style' => '', 'alt' => $contentInfo['Content']['title'], 'title' => $imageCaption], true), true);
					$imageThumbUrl = $this->Html->url($this->Img->showImage('img/images/' . $imageID, ['height' => '150', 'width' => '150', 'type' => 'crop', 'quality' => '85', 'filename' => $imageCaptionSlug], ['style' => '', 'alt' => $contentInfo['Content']['title'], 'title' => $imageCaption], true), true);
					...
					<div style="float:left; border:0px solid #fff; width:auto; padding:2px;">
						<a href="<?php echo $imageUrl; ?>" title='<?php echo $imageCaption; ?>'>
							<img src="<?php echo $imageThumbUrl; ?>"
								 alt="<?php echo $contentInfo['Content']['title']; ?>" width='150' height='150'/>
							<?php
