...
echo $this->Html->meta('keywords', $keywords, ['inline' => false]);
echo $this->Html->meta('description', $description, ['inline' => false]);
...
<div id="homepage">
	...
	<section id="intro" class="clear">
		<article class="one_fifth"><a href="#"><img src="img/images/demo/166x130.gif" width="166" height="130"
													alt=""></a>
		...
		<article class="one_fifth lastbox"><a href="#"><img src="img/images/demo/166x130.gif" width="166" height="130"
															alt=""></a>
			<h2>Indonectetus facilis</h2>
			<p>Nullamlacus dui ipsum conseque loborttis non euisque morbi penas dapibulum orna.</p>
			<footer class="more"><a href="#">Read More &raquo;</a></footer>
