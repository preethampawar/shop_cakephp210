...
class ImgHelper extends AppHelper
{
    ...
    public $cacheDir = 'img/imagecache/';
    public $noImage = 'noimage.jpg';
    public $noImagePath = 'img/noimage.jpg';

    public function showImage($image = null, $options = [], $htmlattributes = [], $returnUrl = false)
    {
    ...
    public function resize($image, $height, $width, $type, $quality = '90', $filename = '')
    {
