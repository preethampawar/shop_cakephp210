		...
		if (!empty($contentInfo['Images'])) {
			...
			<div class="landing-page-slider">
				...
				foreach ($contentInfo['Images'] as $image) {
					...
					$imageUrl = $this->Img->showImage('img/images/' . $imageID, ['height' => '500', 'width' => '960', 'type' => 'exact', 'quality' => '85', 'filename' => $captionSlug], ['style' => '', 'alt' => $imageCaption, 'title' => $imageCaption, 'escape' => false], true);
					...
					<div style="text-align:center;">
						<img alt="<?php echo $imageCaption; ?>" data-lazy="<?php echo $imageUrl; ?>"
						...
						if ($imageCaption != '') {
							?>
							<div
								style="background-color: #25488f; color:#ffffff; padding: 5px 5px;"><?php echo $imageCaption; ?></div>
							<?php
						}
						?>
					</div>
