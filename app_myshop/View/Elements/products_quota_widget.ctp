...
<div class="border p-2 pt-3 rounded">
	...
	<?php if($percentage >= 70): ?>
		<div class="alert alert-warning p-1 mt-1"><i class="bi bi-exclamation-circle"></i> You can add only <?= ($productsLimitForThisSite - $productsCount) ?> products to your store.</div>
	<?php endif; ?>

	<?php if($percentage >= 100): ?>
	<div class="alert alert-danger p-1 mt-1"><i class="bi bi-exclamation-circle"></i> You cannot add anymore products to your store.</div>
	<?php endif; ?>
</div>
