		...
		<div class="col">
			<div class="card card-progressbar text-center bg-light rounded p-2 border">
				...
				<ul id="progressbar" class="mt-4 ps-0 small">
					<li class="active small" id="new"><strong><?= Order::ORDER_STATUS_NEW ?></strong></li>
					<li class="active small" id="confirmed"><strong><?= Order::ORDER_STATUS_CONFIRMED ?></strong></li>
					<li class="active small" id="shipped"><strong><?= Order::ORDER_STATUS_SHIPPED ?></strong></li>
					<li class=" small" id="delivered"><strong><?= Order::ORDER_STATUS_DELIVERED ?></strong></li>
				</ul>
			</div>
		</div>
		<div class="col">
