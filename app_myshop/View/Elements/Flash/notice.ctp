<div aria-live="polite" aria-atomic="true" class="position-relative">
	<div class="toast-container fixed-top end-0 p-2 mt-5" style="left: auto">
		<div id="<?php echo h($key) ?>Message" class="toast toast-php text-white bg-warning border-white" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true" data-bs-delay="1500">
