...
$this->Html->meta('keywords', $blogTitle, ['inline' => false]);
$this->Html->meta('description', $this->Text->truncate($metaDescription, 150), ['inline' => false]);
?>
...
<div>
	...
	<div style="float:left; width:500px;">
		<h2><?php echo $this->Html->link($blogTitle, '/blog/show/' . $blogID . '/' . $blogTitleSlug, ['title' => $blogTitle]); ?></h2>
		...
		if (!empty($images)) {
			...
			<div id="blogImages" class="blog-details-slider">
				...
				foreach ($images as $row) {
					...
					$imageUrl = $this->Html->url($this->Img->showImage('img/images/' . $imageID, ['height' => '600', 'width' => '600', 'type' => 'auto', 'quality' => '85', 'filename' => $imageCaptionSlug], ['style' => '', 'alt' => $blogTitle, 'title' => $imageCaption], true), true);
					$imageThumbUrl = $this->Html->url($this->Img->showImage('img/images/' . $imageID, ['height' => '150', 'width' => '150', 'type' => 'crop', 'quality' => '85', 'filename' => $imageCaptionSlug], ['style' => '', 'alt' => $blogTitle, 'title' => $imageCaption], true), true);
					...
					<div style="float:left; border:0px solid #fff; width:auto; padding:2px;">
						<a href="<?php echo $imageUrl; ?>" title='<?php echo $imageCaption; ?>'>
							<img src="<?php echo $imageThumbUrl; ?>" alt="<?php echo $blogTitle; ?>" width='150'
								 height='150'/>
							<?php
