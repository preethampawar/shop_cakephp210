...
<div>
    ...
    <?php echo $this->Html->link('&laquo; Back &nbsp;', ['controller' => 'sites', 'action' => 'index'], ['escape' => false, 'class' => 'button']); ?>
    <br><br>
    ...
    <table>
        <tr>
            <td style="vertical-align:top;">
                <?php echo $this->Form->input('Site.show_products', ['div' => false, 'label' => false, 'onchange' => 'checkProducts()']); ?>
                <label for="SiteShowProducts">Show Products </label> <br>

                <?php echo $this->Form->input('Site.featured_products', ['div' => false, 'label' => false, 'onclick' => 'checkOrUncheckShowProductsCheckbox(this)']); ?>
                <label for="SiteFeaturedProducts">Show Featured Products</label> <br>

                <?php echo $this->Form->input('Site.request_price_quote', ['div' => false, 'label' => false, 'onclick' => 'checkOrUncheckShowProductsCheckbox(this)']); ?>
                <label for="SiteRequestPriceQuote">Show Request Price Quote</label> <br>

                <?php echo $this->Form->input('Site.image_gallery', ['div' => false, 'label' => false, 'onclick' => 'checkOrUncheckShowProductsCheckbox(this)']); ?>
                <label for="SiteImageGallery">Show Products Photo Gallery</label>

            </td>
            <td style="vertical-align:top; padding-left:50px;">
                <?php echo $this->Form->input('Site.show_landing_page', ['div' => false, 'label' => false]); ?> <label
                        for="SiteShowLandingPage">Show Landing Page</label> <br>

                <?php echo $this->Form->input('Site.show_blog', ['div' => false, 'label' => false]); ?> <label
                        for="SiteShowBlog">Show Blog <br>

                    <?php echo $this->Form->input('Site.under_maintenance', ['div' => false, 'label' => false]); ?>
    ...
    <table style="width:94%; border:0px;" cellpadding='0' cellspacing='0'>
        <tr>
            ...
            <td><?php echo $this->Form->input('Site.title', ['label' => false, 'value' => html_entity_decode($this->data['Site']['title'])]); ?>
        ...
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td><?php echo $this->Form->input('Site.caption', ['label' => false, 'value' => html_entity_decode($this->data['Site']['caption'])]); ?></td>
        </tr>
        <tr>
            <td><label for='SiteServiceType'>Service Type</label></td>
            <td style="width:10px;">:</td>
            <td>
                <?php echo $this->Form->input('Site.service_type', ['label' => false, 'value' => html_entity_decode($this->data['Site']['service_type']), 'list' => 'servicetypes', 'type' => 'text']);
                ?>
        ...
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td><?php echo $this->Form->input('Site.contact_phone', ['label' => false, 'type' => 'number', 'div' => false, 'minlength' => '10', 'maxlength' => '55', 'required' => true, 'placeholder' => 'Enter Contact Phone No.', 'title' => 'Enter Contact Phone No.']); ?></td>
        </tr>
        <tr>
            <td>Contact Email Address*</td>
            <td style="width:10px;">:</td>
            <td><?php echo $this->Form->input('Site.contact_email', ['label' => false, 'type' => 'email', 'div' => false, 'required' => true, 'placeholder' => 'Enter Contact Email.. ', 'title' => 'Enter Contact Email..']); ?></td>
        </tr>
        <tr>
            <td><label for='SiteAddress'>Contact Address*</label></td>
            <td style="width:10px;">:</td>
            <td>
                <?php echo $this->Form->input('Site.address', ['label' => false, 'type' => 'textarea', 'rows' => 2, 'required' => true]); ?>
            </td>
        </tr>
    </table>
    <br>
    <table style="width:95%;">
        <tr>
            <td>
                ...
                <?php echo $this->Form->textarea('Site.description', ['rows' => '20', 'class' => 'tinymce']); ?>
            </td>
            <td style="width:10px;">:</td>
        </tr>
    </table>
    ...
    <table style="width:94%; border:0px;" cellpadding='0' cellspacing='0'>
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td><?php echo $this->Form->input('Site.meta_keywords', ['label' => false, 'type' => 'text', 'value' => html_entity_decode($this->data['Site']['meta_keywords'])]); ?>
                <div class="note">*max 10 unique words or phrases, without any special characters. (Required for search
                    engines. ex: google, bing, yahoo)
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td><?php echo $this->Form->input('Site.meta_description', ['label' => false, 'type' => 'text', 'value' => html_entity_decode($this->data['Site']['meta_description'])]); ?>
                <div class="note">*max 150-160 characters, without any special characters. (Required for search engines.
        ...
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td>
                <?php echo $this->Form->input('Site.analytics_code', ['label' => false, 'type' => 'textarea', 'rows' => 2]); ?>
        ...
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td>
                <?php echo $this->Form->input('Site.search_engine_code', ['label' => false, 'type' => 'textarea', 'rows' => 2]); ?>
        ...
        <tr>
            ...
            <td style="width:10px;">:</td>
            <td>
                <?php echo $this->Form->input('Site.embed_map', ['label' => false, 'type' => 'text']); ?>
        ...
        <tr>
            ...
            <td>
                ...
                <br><br>
                <?php echo $this->Html->link('&nbsp; Cancel &nbsp;', ['controller' => 'sites', 'action' => 'index'], ['escape' => false, 'class' => 'button']); ?>
            </td>
        </tr>
    </table>
</div>
