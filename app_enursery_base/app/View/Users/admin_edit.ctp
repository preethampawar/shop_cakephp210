...
<div>		
	...
	<table style='width:500px;'>
		...
		<tr>
			...
			<td><?php echo $this->Form->input('Site.id', array('label'=>false, 'options'=>$sites, 'div'=>false, 'required'=>true));?></td>
		</tr>
		<?php
		}
		?>
		...
		<tr>
			...
			<td><?php echo $this->Form->input('User.address', array('label'=>false, 'type'=>'text', 'div'=>false, 'placeholder'=>'Enter Street Address', 'value'=>html_entity_decode($this->data['User']['address'])));?></td>
		</tr>
		<tr>
			<td>City</td>
		...
		<tr>
			...
			<td>
				...
				&nbsp;&nbsp;
				<?php echo $this->Html->link('Cancel &nbsp;&raquo;', array('controller'=>'users', 'action'=>'userInfo', $userID), array('escape'=>false));?>
			</td>
		</tr>
	</table>	
