...
<div itemscope itemtype ="http://schema.org/ContactPage">
	<meta itemprop="url" content="http://www.letsgreenify.in/users/contactus" />
		...
		<tr>
			...
			<td>
				<?php 
					...
					?>
					<button class="g-recaptcha button small green" data-sitekey="your_site_key" data-callback='onSubmit'>Submit</button>
					<br/>
