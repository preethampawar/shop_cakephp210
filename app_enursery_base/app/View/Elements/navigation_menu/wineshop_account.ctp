		...
		<ul id="mega-menu-3" class="mega-menu">
			...
			<li>
				...
				<ul>
					...
					<li><?php echo $this->Html->link('Available Stock', '#');?>	
						<ul>
							<li><?php echo $this->Html->link('Add Available Stock', array('controller'=>'available_stock', 'action'=>'add'));?></li>
							<li><?php echo $this->Html->link('Show Available Stock', '/available_stock/');?></li>					
						</ul>
					</li>		
